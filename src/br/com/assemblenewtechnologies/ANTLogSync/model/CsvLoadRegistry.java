...
public class CsvLoadRegistry {
	...
	private Logger LOGGER = LoggerFactory.getLogger(CsvLoadRegistry.class);
	 ...
	 * @throws Exception
	 */
	public CsvLoadRegistry(String lot_name, String file_name, String load_path, int status,
			BigDecimal processment_execution_id) throws Exception {
	...
	private void save() throws Exception {
		if (lot_name == null || lot_name.equals("") || file_name == null || file_name.equals("") 
